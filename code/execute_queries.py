...
query1 = """USE [AdventureWorks2019];SELECT * FROM HumanResources.Employee AS E ORDER BY E.JobTitle"""
cursor.execute(query1)
query_to_csv(cursor, file1)

file2 = 'ByLastName.csv'
query2 = """USE [AdventureWorks2019];SELECT * FROM HumanResources.Employee AS E JOIN Person.Person AS P ON E.BusinessEntityID=P.BusinessEntityID ORDER BY LastName"""
cursor.execute(query2)
query_to_csv(cursor, file2)

file3 = 'Only3colByLastName.csv'
query3 = """USE [AdventureWorks2019];SELECT P.FirstName, P.LastName, P.BusinessEntityID AS Employee_id FROM Person.Person AS P ORDER BY P.LastName"""
